        ...
        <>
            <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-green-50 to-green-25">
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full max-w-md">
                    <span>
                        <Image src="/logoInforme.png" preview={false} />
                    </span>
                    ...
                    <form onSubmit={onSubmit} method="POST" className="mt-4">
                        ...
                        <div className="flex items-center justify-center">
                            <button
                                type="submit"
                                className="items-center justify-center bg-gradient-to-r from-green-800 to-green-300 hover:from-green-500 hover:to-green-100 text-white font-bold py-3 px-4 rounded focus:outline-none focus:shadow-outline w-full inline-flex"
                            >
            ...
            <a href="#" className="text-gray-600 hover:underline">¿Olvidaste la contraseña?</a>
                    ...
                    <p className="text-center text-gray-600 mt-6">
                        Si no tienes una cuenta, contacta con el administrador
                    </p>
                    {/*<div className="mt-4">
