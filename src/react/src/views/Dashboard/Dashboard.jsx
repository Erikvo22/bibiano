...
import { Layout, Button, Card, Space, Typography, Row, Col, Modal, Input, Radio } from 'antd';
    ...
    <Layout className='min-h-screen'>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button hidden={isWorking} key="start" 
                  style={{ background: 'green', color: 'white' }}
                  onClick={handleOkStart}>
           Fichar entrada
         </Button>
          <Button hidden={!isWorking} key="stop" 
                  disabled={newType == 1} style={{ background: newType == 1 ? 'grey' : 'green', color: 'white' }}
      ...
      >
        ...
        <Radio.Group onChange={onChange} value={newType}>
            <Space direction="vertical">
              ...
              <Radio value={6}>
                Otro...
                {newType === 6 ? <Input value={newComment} onChange={onChangeComment} style={{ width: 100, marginLeft: 10 }} /> : null}
              </Radio>
            </Space>
          </Radio.Group>
          </div>
